...
var App = angular.module('carrus', ['angular-img-cropper','ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'ui.utils', 'chart.js', 'ng-fusioncharts','ui.mask'])
    .run(["$rootScope", "$state", "$stateParams", '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
        ...
        $rootScope.user = {
            name: 'Admin',
            job: 'Carrus',
            picture: 'app/img/logo_whiteonblack.jpg'
        };
    ...
    .constant('APP_REQUIRES', {
        ...
        modules: [
            ...
            },
            {
                ...
                files: ['vendor/angular-google-maps/angular-google-maps.min.js', 'vendor/angular-google-maps/lodash.min.js']
            },
...
App.controller('AppController',
    ['$rootScope', '$scope', '$state', '$translate', '$window', '$localStorage', '$timeout', 'toggleStateService', 'colors', 'browser', 'cfpLoadingBar', "$cookieStore",
        function ($rootScope, $scope, $state, $translate, $window, $localStorage, $timeout, toggle, colors, browser, cfpLoadingBar, $cookieStore) {
            ...
            if (typeof $cookieStore.get('accessToken') == "undefined") {
 ...
 * [panel-refresh] * [data-spinner="standard"]
 =========================================================*/
App.directive('panelRefresh', ["$q", function ($q) {
    'use strict';
...
App.factory('fileReader', ["$q", "$log", function ($q, $log, fileUserReader) {
