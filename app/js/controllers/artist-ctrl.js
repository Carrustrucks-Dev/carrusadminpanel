...
// Change Status Dialog
    $scope.changeStatus = function (status, userid) {
        ...
        $scope.addTeam = {};
        ngDialog.open({
            template: 'app/views/status-dialog-artist.html',
            className: 'ngdialog-theme-default',
            scope: $scope
        });
    };

    $scope.change = function (user_val, status) {
        if (status == 1) {
            console.log("dfs");
            ...
            $.ajax({
                method: 'PUT',
                url: 'http://52.6.32.171:8888/api/admin/unblockUser',
                dataType: 'json',
                data: data,
                success: function (data) {
                    $window.location.reload();
        ...
        //$.post('http://52.6.32.171:8888/api/admin/blockUser',data,function(data) {console.log(data)});
        //$http.put({
        //    url: 'http://52.6.32.171:8888/api/admin/blockUser/',
